...
def _get_version():
    ...
    with open(join(dirname(__file__), 'marvin_recommendation_system_engine/VERSION'), 'rb') as f:
...
setup(
    name='marvin_recommendation_system_engine',
    version=_get_version(),
    url='',
    description='Build a reocmmendation system in Marvin',
