# recommendation_system_engine v0.0.1

## Overview

Build a reocmmendation system in Marvin
...
```
mkvirtualenv marvin_recommendation_system_engine_env
```
...
The default log level is set to _WARNING_. You can change the log level at runtime setting another value to one of the following environment variable: `MARVIN_RECOMMENDATION_SYSTEM_ENGINE_LOG_LEVEL` or `LOG_LEVEL`. The available values are _CRITICAL_, _ERROR_, _WARNING_, _INFO_ and _DEBUG_.
